...
class Constants():
    ...
    processed_distances: str = "Distances"
...
class Folders():
    ...
    path_distances = os.path.join(__current_directory,
                                  Constants.processed_distances)
    proccessed_data_path = os.path.join(__current_directory,
                                        Constants.proccessed_data_folder)
    graph_info_path = os.path.join(__current_directory, Constants.data_folder,
                                   Constants.graph_info_txt)
    results_path = os.path.join(__current_directory, Constants.results_folder)
    results_ray_path = os.path.join(__current_directory,
                                    Constants.results_ray_folder)
    path_save_plots = os.path.join(__current_directory,
                                   Constants.folder_save_plots)
    ...
    def CreateFolders(self) -> None:
        ...
        if not os.path.exists(self.path_distances):
            os.makedirs(self.path_distances)
...
class DistanceType(Enum):
    r"""
        Enumeration for how the distance is calculated
            Geodesic = 0
            OSRM = 1
    """
    Geodesic = 0
